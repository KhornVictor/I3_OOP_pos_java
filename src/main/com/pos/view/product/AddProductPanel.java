...
public class AddProductPanel extends JPanel {
    ...
    private JPanel createActionsPanel() {
        ...
        // Save Button
        saveButton = createModernButton("Save Product", new Color(34, 139, 34), Color.WHITE);
    ...
    private void saveProduct() {
        ...
        try {
            ...
            newProduct.setCategoryId(ProductDAO.getCategoryIdByName((String) categoryCombo.getSelectedItem()));
            newProduct.setPrice((Double) priceSpinner.getValue());
            newProduct.setStockQuantity((Integer) stockSpinner.getValue());
            imagePanel.saveImageToResources(name.toLowerCase().replaceAll("\\s+", "_") + ".png");
            newProduct.setImage("/images/product/" + name.toLowerCase().replaceAll("\\s+", "_") + ".png");
